...
|---|---|---|---|---|---|
| CDLHIKKAKEMOD | TA-Lib | MISMATCH | **FAIL** (err 1.0e+02, nan 0) | — | — |
| CDLLADDERBOTTOM | TA-Lib | MISMATCH | **FAIL** (err 1.0e+02, nan 0) | — | — |
| CDLTRISTAR | TA-Lib | MISMATCH | **FAIL** (err 1.0e+02, nan 0) | — | — |
| CDLUNIQUE3RIVER | TA-Lib | MISMATCH | **FAIL** (err 1.0e+02, nan 0) | — | — |
...
- Mismatches: CDLHIKKAKEMOD, CDLLADDERBOTTOM, CDLTRISTAR, CDLUNIQUE3RIVER, LINEARREG_ANGLE, LINEARREG_SLOPE, rolling_skew, rolling_kurtosis
- Errors: none
