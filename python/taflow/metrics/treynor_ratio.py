...
class TreynorRatio:
    ...
    def from_returns(self, returns: Any, benchmark_returns: Any) -> "TreynorRatio":
    ...
    def from_log_returns(self, log_returns: Any, benchmark_log_returns: Any) -> "TreynorRatio":
    ...
    def from_equity(self, equity: Any, benchmark_equity: Any) -> "TreynorRatio":
    ...
    def from_pnl(self, pnl: Any, benchmark_pnl: Any, initial_capital: float, benchmark_initial_capital: float) -> "TreynorRatio":
