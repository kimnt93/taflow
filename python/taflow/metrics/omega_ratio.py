...
class OmegaRatio:
    ...
    independent oracle mapping is ``empyrical.stats.omega_ratio`` from
    ...
    def from_returns(self, returns: Any, *, column: str | None=None) -> 'OmegaRatio':
    ...
    def from_log_returns(self, log_returns: Any, *, column: str | None=None) -> 'OmegaRatio':
    ...
    def from_equity(self, equity: Any, *, column: str | None=None) -> 'OmegaRatio':
    ...
    def from_pnl(self, pnl: Any, initial_capital: float, *, column: str | None=None) -> 'OmegaRatio':
