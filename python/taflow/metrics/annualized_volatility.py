...
class AnnualizedVolatility:
    ...
    independent oracle mapping is ``empyrical.stats.annual_volatility`` from
    ...
    def from_returns(self, returns: Any, *, column: str | None=None) -> 'AnnualizedVolatility':
    ...
    def from_log_returns(self, log_returns: Any, *, column: str | None=None) -> 'AnnualizedVolatility':
    ...
    def from_equity(self, equity: Any, *, column: str | None=None) -> 'AnnualizedVolatility':
    ...
    def from_pnl(self, pnl: Any, initial_capital: float, *, column: str | None=None) -> 'AnnualizedVolatility':
    ...
    def extend(self, values: Any, *, column: str | None=None) -> 'AnnualizedVolatility':
