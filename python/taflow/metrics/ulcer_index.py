...
class UlcerIndex:
    ...
    independent oracle mapping is ``quantstats.stats.ulcer_index`` from
    quantstats 0.0.81.
    ...
    def from_returns(self, returns: Any, *, column: str | None=None) -> 'UlcerIndex':
    ...
    def from_log_returns(self, log_returns: Any, *, column: str | None=None) -> 'UlcerIndex':
    ...
    def from_equity(self, equity: Any, *, column: str | None=None) -> 'UlcerIndex':
    ...
    def from_pnl(self, pnl: Any, initial_capital: float, *, column: str | None=None) -> 'UlcerIndex':
    ...
    def extend(self, values: Any, *, column: str | None=None) -> 'UlcerIndex':
