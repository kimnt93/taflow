...
class Liquidity:
    ...
    """
    def __init__(self, high: Any, low: Any, swing_length: int = 50,
                 range_percent: float = 0.01) -> None:
        self._state = _Native(int(swing_length), float(range_percent)); self._length = 0
