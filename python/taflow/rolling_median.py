"""Persistent causal rolling median operator."""

from typing import Any
import numpy as np
from ._native import RollingMedianOperator as _Native
...
class RollingMedian:
    ...
    def append(self, _input: float) -> "RollingMedian":
    ...
    def extend(self, _input: Any) -> "RollingMedian":
