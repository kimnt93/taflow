...
import numpy as np
from ._native import GarmanKlassYangZhangOperator as _Native
...
class GarmanKlassYangZhang:
    ...
    def append(self, _open: float, high: float, low: float, close: float) -> "GarmanKlassYangZhang":
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any) -> "GarmanKlassYangZhang":
    ...
    def reset(self) -> "GarmanKlassYangZhang":
