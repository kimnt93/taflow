...
class HeikinAshi:
    ...
    def __init__(self, _open: Any | None = None, high: Any | None = None,
                 low: Any | None = None, close: Any | None = None):
        self._state = StatefulHeikinAshi()
        if _open is not None or high is not None or low is not None or close is not None:
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any):
        ...
        self._state.extend(np.asarray(_open, dtype=np.float64),
