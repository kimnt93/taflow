...
class CandleThreeLineStrike:
    ...
    def append(self, _open: float, high: float, low: float, close: float) -> "CandleThreeLineStrike":
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any) -> "CandleThreeLineStrike":
    ...
    def reset(self) -> "CandleThreeLineStrike":
