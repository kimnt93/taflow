...
from .._native import FourPointHarmonicPattern as _Native
from .._series import as_float64_series


class FourPointHarmonicPattern:
    """Causal four-point ABCD harmonic reversal detector over aligned OHLC bars.
    ...
    def reset(self) -> "FourPointHarmonicPattern":
