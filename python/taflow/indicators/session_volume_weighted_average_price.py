...
import numpy as np
from .._native import SessionVolumeWeightedAveragePrice as _Native
...
class SessionVolumeWeightedAveragePrice:
    ...
    def append(self,open:float,high:float,low:float,close:float,volume:float,timestamp:int)->"SessionVolumeWeightedAveragePrice":self._state.append(float(open),float(high),float(low),float(close),float(volume),int(timestamp));return self
    def extend(self,open:Any,high:Any,low:Any,close:Any,volume:Any,timestamp:Any)->"SessionVolumeWeightedAveragePrice":
    ...
    def reset(self)->"SessionVolumeWeightedAveragePrice":self._state.reset();return self
