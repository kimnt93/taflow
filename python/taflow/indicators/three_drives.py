...
from .._native import ThreeDrives as _Native
from .._series import as_float64_series


class ThreeDrives:
    """Causal three-drives reversal detector over aligned OHLC bars.
    ...
    mapping is Wickra 0.9.9 ThreeDrives; TA-Lib has no equivalent pattern function.
    """
    ...
    def extend(self, open: Any, high: Any, low: Any, close: Any) -> "ThreeDrives":
