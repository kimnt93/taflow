...
class RollingCoefficientOfDetermination:
    ...
    def append(self,x:float,y:float)->"RollingCoefficientOfDetermination":self._state.append(float(x),float(y));return self
    ...
    def reset(self)->"RollingCoefficientOfDetermination":self._state.reset();return self
