"""Persistent pointwise asin transform."""

from typing import Any

from .._math_state import MathUnaryState
from .._native import MathAsin as _NativeMathAsin


class MathAsin(MathUnaryState):
    """Apply pointwise asin in persistent Rust state.
