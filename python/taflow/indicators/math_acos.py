"""Persistent pointwise acos transform."""

from typing import Any

from .._math_state import MathUnaryState
from .._native import MathAcos as _NativeMathAcos


class MathAcos(MathUnaryState):
    """Apply pointwise acos in persistent Rust state.
