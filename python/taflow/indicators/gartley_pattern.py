...
from .._native import GartleyPattern as _Native
from .._series import as_float64_series


class GartleyPattern:
    """Causal Gartley harmonic reversal detector over aligned OHLC bars.
    ...
    def extend(self, open: Any, high: Any, low: Any, close: Any) -> "GartleyPattern":
