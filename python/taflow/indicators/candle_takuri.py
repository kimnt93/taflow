...
class CandleTakuri:
    ...
    def append(self, _open: float, high: float, low: float, close: float) -> "CandleTakuri":
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any) -> "CandleTakuri":
