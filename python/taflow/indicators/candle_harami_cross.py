"""Persistent CandleHarami Cross recognition (CDLHARAMICROSS)."""

from typing import Any
import numpy as np
from .._native import CandleHaramiCross as _Native
from .._candle_ohlc import as_ohlc_arrays


class CandleHaramiCross:
    """Persistent CandleHarami Cross recognition (CDLHARAMICROSS).
    ...
    def append(self, _open: float, high: float, low: float, close: float) -> "CandleHaramiCross":
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any) -> "CandleHaramiCross":
    ...
    def reset(self) -> "CandleHaramiCross":
