...
from .._native import CrabPattern as _Native
from .._series import as_float64_series


class CrabPattern:
    """Causal Crab harmonic reversal detector over aligned OHLC bars.
    ...
    mapping is Wickra 0.9.9 Crab; TA-Lib has no equivalent pattern function.
    """
    ...
    def extend(self, open: Any, high: Any, low: Any, close: Any) -> "CrabPattern":
