...
from .._native import TripleTopBottom as _Native
from .._series import as_float64_series


class TripleTopBottom:
    """Causal triple-top and triple-bottom detector over aligned OHLC bars.
    ...
    mapping is Wickra 0.9.9 TripleTopBottom; TA-Lib has no equivalent pattern function.
    """
    ...
    def extend(self, open: Any, high: Any, low: Any, close: Any) -> "TripleTopBottom":
    ...
    def reset(self) -> "TripleTopBottom":
