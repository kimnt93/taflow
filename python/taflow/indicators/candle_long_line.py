...
class CandleLongLine:
    ...
    def append(self, _open: float, high: float, low: float, close: float) -> "CandleLongLine":
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any) -> "CandleLongLine":
