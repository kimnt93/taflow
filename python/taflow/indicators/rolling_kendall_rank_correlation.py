...
class RollingKendallRankCorrelation:
    ...
    def append(self, x: float, y: float) -> "RollingKendallRankCorrelation": self._state.append(float(x), float(y)); return self
    ...
    def reset(self) -> "RollingKendallRankCorrelation": self._state.reset(); return self
