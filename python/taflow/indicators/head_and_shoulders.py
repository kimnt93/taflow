...
from .._native import HeadAndShoulders as _Native
from .._series import as_float64_series


class HeadAndShoulders:
    """Causal head-and-shoulders and inverse-head-and-shoulders detector over aligned OHLC bars.
    ...
    mapping is Wickra 0.9.9 HeadAndShoulders; TA-Lib has no equivalent pattern function.
    """
    ...
    def extend(self, open: Any, high: Any, low: Any, close: Any) -> "HeadAndShoulders":
    ...
    def reset(self) -> "HeadAndShoulders":
