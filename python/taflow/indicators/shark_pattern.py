...
from .._native import SharkPattern as _Native
from .._series import as_float64_series


class SharkPattern:
    """Causal Shark harmonic reversal detector over aligned OHLC bars.
    ...
    mapping is Wickra 0.9.9 Shark; TA-Lib has no equivalent pattern function.
    """
    ...
    def extend(self, open: Any, high: Any, low: Any, close: Any) -> "SharkPattern":
