...
class RollingGainLossRatio:
    ...
    def append(self, value: float) -> "RollingGainLossRatio": self._state.append(float(value)); return self
    def extend(self, values: Any) -> "RollingGainLossRatio": self._state.extend(as_float64_series(values)); return self
    def compute(self) -> np.ndarray: return self._state.compute()
    @property
    def value(self) -> float | None: return self._state.value
    def reset(self) -> "RollingGainLossRatio": self._state.reset(); return self
