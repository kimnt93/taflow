"""Persistent Morning Star recognition (CDLMORNINGSTAR)."""

from typing import Any
import numpy as np
from .._native import CandleMorningStar as _Native
from .._candle_ohlc import as_ohlc_arrays


class CandleMorningStar:
    """Persistent Morning Star recognition (CDLMORNINGSTAR).
    ...
    def append(self, _open: float, high: float, low: float, close: float) -> "CandleMorningStar":
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any) -> "CandleMorningStar":
    ...
    def reset(self) -> "CandleMorningStar":
