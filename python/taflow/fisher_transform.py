...
class FisherTransform:
    ...
    """
    def __init__(self,high:Any|None=None,low:Any|None=None,timeperiod:int=10):self._state=_Native(timeperiod);self.extend(high,low) if high is not None or low is not None else None
