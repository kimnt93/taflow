"""Persistent Rise Fall Three Methods recognition (CDLRISEFALL3METHODS)."""

from typing import Any
import numpy as np
from ._native import CandleRiseFallThreeMethods as _Native
from ._candle_ohlc import as_ohlc_arrays


class CandleRiseFallThreeMethods:
    """Persistent Rise Fall Three Methods recognition (CDLRISEFALL3METHODS).
    ...
    def append(self, _open: float, high: float, low: float, close: float) -> "CandleRiseFallThreeMethods":
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any) -> "CandleRiseFallThreeMethods":
    ...
    def reset(self) -> "CandleRiseFallThreeMethods":
