"""Causal fair-value-gap detection and mitigation."""
from typing import Any
import numpy as np
from ._native import FvgOperator as _Native
...
class FairValueGap:
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any):
        self._state.extend(as_float64_series(_open), as_float64_series(high), as_float64_series(low), as_float64_series(close))
        return self
