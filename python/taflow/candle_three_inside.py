...
class CandleThreeInside:
    ...
    def append(self, _open: float, high: float, low: float, close: float) -> "CandleThreeInside":
    ...
    def extend(self, _open: Any, high: Any, low: Any, close: Any) -> "CandleThreeInside":
    ...
    def reset(self) -> "CandleThreeInside":
