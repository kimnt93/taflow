"""Persistent causal rolling skew operator."""

from typing import Any
import numpy as np
from ._native import RollingSkewOperator as _Native
...
class RollingSkew:
    ...
    def extend(self, _input: Any) -> "RollingSkew":
