...
fn _native(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<indicators::LongLeggedDoji>()?;
    m.add_class::<indicators::Rickshawman>()?;
    m.add_class::<indicators::HighWave>()?;
    m.add_class::<indicators::DragonflyDoji>()?;
    m.add_class::<indicators::GravestoneDoji>()?;
    m.add_class::<indicators::ShortLine>()?;
    ...
    m.add_class::<indicators::ThreeLineStrike>()?;
    m.add_class::<indicators::ThreeStarsInSouth>()?;
    m.add_class::<indicators::ThreeOutside>()?;
