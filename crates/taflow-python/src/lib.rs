...
fn _native(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<state_api::StatefulMathAbs>()?;
    m.add_class::<state_api::StatefulMathAcos>()?;
    m.add_class::<state_api::StatefulMathAcosh>()?;
    m.add_class::<state_api::StatefulMathAsin>()?;
    m.add_class::<state_api::StatefulMathAsinh>()?;
    m.add_class::<state_api::StatefulMathAtan>()?;
    m.add_class::<state_api::StatefulMathAtanh>()?;
    m.add_class::<state_api::StatefulMathCbrt>()?;
    m.add_class::<state_api::StatefulMathCeil>()?;
    m.add_class::<state_api::StatefulMathCos>()?;
    m.add_class::<state_api::StatefulMathCosh>()?;
    m.add_class::<state_api::StatefulMathCot>()?;
    m.add_class::<state_api::StatefulMathDegrees>()?;
    m.add_class::<state_api::StatefulMathExp>()?;
    m.add_class::<state_api::StatefulMathFloor>()?;
    m.add_class::<state_api::StatefulMathLn>()?;
    m.add_class::<state_api::StatefulMathLog10>()?;
    m.add_class::<state_api::StatefulMathLog1p>()?;
    m.add_class::<state_api::StatefulMathRadians>()?;
    m.add_class::<state_api::StatefulMathSin>()?;
    m.add_class::<state_api::StatefulMathSinh>()?;
