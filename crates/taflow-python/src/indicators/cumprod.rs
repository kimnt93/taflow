...
use pyo3::prelude::*;
use taflow::stream::Cumprod;

#[pyclass]
pub struct CumprodOperator { inner: Cumprod, outputs: Vec<f64> }

#[pymethods]
impl CumprodOperator {
    #[new]
    fn new() -> Self { Self { inner: Cumprod::new(), outputs: Vec::new() } }
