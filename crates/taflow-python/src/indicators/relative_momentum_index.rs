...
use pyo3::prelude::*;
use taflow::stream::{RelativeMomentumIndex as RelativeMomentumIndexState, StreamingIndicator};

/// Python boundary for the canonical Rust Relative Momentum Index state.
#[pyclass]
pub struct RelativeMomentumIndex {
    inner: RelativeMomentumIndexState,
    output: Vec<f64>,
}
...
impl RelativeMomentumIndex {
    ...
    fn new(timeperiod: usize, momentum: usize) -> PyResult<Self> {
        Ok(Self {
            inner: RelativeMomentumIndexState::new(timeperiod, momentum)
