...
use pyo3::prelude::*;
use taflow::indicators::RogersSatchell;

#[pyclass]
pub struct RogersSatchellOperator {
    inner: RogersSatchell,
    output: Vec<f64>,
}

#[pymethods]
impl RogersSatchellOperator {
    #[new]
    #[pyo3(signature = (timeperiod=20))]
    fn new(timeperiod: usize) -> PyResult<Self> {
        Ok(Self {
            inner: RogersSatchell::new(timeperiod)
