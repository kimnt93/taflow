...
use pyo3::prelude::*;
use taflow::indicators::CandleBeltHold as CandleBeltHoldState;
#[pyclass]
/// Stateful CandleBeltHold candlestick recognizer.
/// Inputs are OHLC bars; output is the aligned integer pattern score.
pub struct CandleBeltHold {
    inner: CandleBeltHoldState,
    outputs: Vec<i32>,
}
#[pymethods]
impl CandleBeltHold {
