...
#[pyclass]
pub struct LogReturnOperator { inner: LogReturn, outputs: Vec<f64> }

#[pymethods]
impl LogReturnOperator {
    #[new]
    fn new(timeperiod: usize) -> PyResult<Self> {
        Ok(Self { inner: LogReturn::new(timeperiod).map_err(|e| PyValueError::new_err(e.to_string()))?, outputs: Vec::new() })
    }
