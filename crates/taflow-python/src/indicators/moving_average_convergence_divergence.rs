...
use pyo3::prelude::*;
use taflow::indicators::MovingAverageConvergenceDivergence as State;

/// Native-backed Python boundary for canonical MACD state.
#[pyclass]
...
impl MovingAverageConvergenceDivergence {
    ...
    fn new(fastperiod: usize, slowperiod: usize, signalperiod: usize) -> PyResult<Self> {
        Ok(Self {
            inner: State::new(fastperiod, slowperiod, signalperiod)
