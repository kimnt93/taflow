...
use pyo3::prelude::*;
use taflow::stream::{
    self, AverageDirectionalIndex, AverageDirectionalIndexRating, DirectionalMovementIndex,
    FastStochasticOscillator, MesaAdaptiveMovingAverage, StochasticOscillator,
    StochasticRelativeStrengthIndex, StreamingIndicator,
