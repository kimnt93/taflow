...
use pyo3::prelude::*;
use taflow_metrics::{metrics::TreynorRatio as State, NanPolicy};
...
impl TreynorRatio {
    #[new]
    #[pyo3(signature = (periods_per_year=252.0, annual_risk_free_rate=0.0, nan_policy="omit"))]
    fn new(periods_per_year: f64, annual_risk_free_rate: f64, nan_policy: &str) -> PyResult<Self> {
        Ok(Self {
            inner: State::new(
                periods_per_year,
