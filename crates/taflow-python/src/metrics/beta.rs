...
use pyo3::prelude::*;
use taflow_metrics::{metrics::Beta as State, MetricInputKind, NanPolicy};
...
fn input_kinds(
    ...
    match (name, initial_equity, benchmark_initial_equity) {
        ...
        _ => Err(PyValueError::new_err("unsupported Beta input mode")),
    }
}

/// Native state backing `taflow.metrics.Beta`.
