...
use pyo3::prelude::*;
use taflow_metrics::{metrics::UpDownCaptureRatio as State, MetricInputKind, NanPolicy};
...
fn input_kinds(
    ...
    match (name, initial_equity, benchmark_initial_equity) {
        ...
        _ => Err(PyValueError::new_err(
            "unsupported UpDownCaptureRatio input mode",
        )),
    }
}

/// Native state backing `taflow.metrics.UpDownCaptureRatio`.
#[pyclass(module = "taflow._native.metrics")]
pub(crate) struct UpDownCaptureRatio {
    inner: State,
}
