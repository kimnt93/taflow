...
use pyo3::prelude::*;
use taflow_metrics::{metrics::Alpha as State, MetricInputKind, NanPolicy};
...
fn input_kinds(
    ...
    match (name, initial_equity, benchmark_initial_equity) {
        ...
        _ => Err(PyValueError::new_err("unsupported Alpha input mode")),
    }
}

/// Native state backing `taflow.metrics.Alpha`.
