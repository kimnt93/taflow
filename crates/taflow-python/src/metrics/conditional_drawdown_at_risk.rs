...
use pyo3::prelude::*;
use taflow_metrics::{metrics::ConditionalDrawdownAtRisk as State, NanPolicy};
...
impl ConditionalDrawdownAtRisk {
    #[new]
    #[pyo3(signature = (confidence=0.95, nan_policy="omit"))]
    fn new(confidence: f64, nan_policy: &str) -> PyResult<Self> {
        Ok(Self {
            inner: State::new(
                confidence,
