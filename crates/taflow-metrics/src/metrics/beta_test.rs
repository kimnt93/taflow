...
fn omits_missing_values_pairwise_and_handles_undefined_cases() {
    ...
    let mut constant_benchmark = Beta::new(
        MetricInputKind::Returns,
        MetricInputKind::Returns,
        NanPolicy::Omit,
    )
