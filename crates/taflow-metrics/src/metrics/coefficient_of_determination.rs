...
/// Squared Pearson correlation of aligned primary and benchmark returns.
#[derive(Debug, Clone)]
pub struct CoefficientOfDetermination {
...
impl CoefficientOfDetermination {
    ...
    pub fn new(
        ...
        if matches!(
            ...
            return Err(MetricError::InvalidParameter {
                ...
                reason: "coefficient of determination requires returns, log returns, equity, or period P&L with initial equity",
            });
        }
    ...
    /// Append one aligned pair and return the current coefficient when defined.
    ...
    /// Return squared Pearson correlation for the usable aligned pairs.
    ///
    /// At least two usable pairs and non-zero variance in both series are
    /// required. The value is `None` while either condition is unsatisfied.
