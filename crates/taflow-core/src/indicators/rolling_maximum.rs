...
use crate::stream::rolling_extrema::MonotonicMax;
use crate::stream::{vhgw, StreamingIndicator};

/// Persistent trailing maximum over a fixed number of observations.
#[derive(Debug, Clone)]
pub struct RollingMaximum {
...
impl StreamingIndicator for RollingMaximum {
    type Output = f64;
