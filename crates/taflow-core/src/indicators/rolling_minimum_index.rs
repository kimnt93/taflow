...
use crate::stream::rolling_extrema::{tracked_index_rescan_into, MonotonicArgmin};
use crate::stream::StreamingIndicator;

/// Persistent TA-Lib-compatible rolling minimum index.
#[derive(Debug, Clone)]
pub struct RollingMinimumIndex {
    extrema: MonotonicArgmin,
    value: Option<f64>,
}

impl RollingMinimumIndex {
...
impl StreamingIndicator for RollingMinimumIndex {
    type Output = f64;
