...
/// Computes an aligned Minus Directional Indicator vector from HLC slices.
pub fn minus_directional_indicator(high: &[f64], low: &[f64], close: &[f64], timeperiod: usize) -> TaResult<Vec<f64>> {
