...
#[derive(Debug, Clone)]
/// Persistent Rust state or aligned output type for `PivotPoints`.
///
...
impl PivotPoints {
    ...
    pub fn new() -> Self {
        Self {
            ...
            low: None,
            close: None,
            levels: (f64::NAN, f64::NAN, f64::NAN, f64::NAN, f64::NAN),
        }
    }
    ...
    pub fn append(
        ...
        if anchor {
                ...
                (self.high, self.low, self.close)
            {
                ...
                self.levels = (
                    pivot,
                    2.0 * pivot - previous_low,
                    2.0 * pivot - previous_high,
                    pivot - range,
                    pivot + range,
                );
            }
    ...
    pub fn value(&self) -> (f64, f64, f64, f64, f64) {
        self.levels
    }
    ...
    pub fn reset(&mut self) {
        ...
        self.low = None;
        self.close = None;
        self.levels = (f64::NAN, f64::NAN, f64::NAN, f64::NAN, f64::NAN);
    }
}
