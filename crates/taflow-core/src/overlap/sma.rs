...
mod tests {
    ...
    fn test_sma_basic() {
        ...
        let result = simple_moving_average(&input, 3).unwrap();
    ...
    fn test_sma_period_1() {
        ...
        let result = simple_moving_average(&input, 1).unwrap();
    ...
    fn test_sma_insufficient_data() {
        ...
        assert!(simple_moving_average(&input, 3).is_err());
    }

    #[test]
    fn test_sma_invalid_period() {
        let input = vec![1.0, 2.0, 3.0];
        assert!(simple_moving_average(&input, 0).is_err());
    }
}
