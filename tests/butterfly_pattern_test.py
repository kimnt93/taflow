...
from taflow import ButterflyPattern


def test_butterfly_pattern_lifecycle_and_alignment() -> None:
    length = 6
    ...
    indicator = ButterflyPattern(open_, high, low, close)
    ...
    with pytest.raises(ValueError):
        ButterflyPattern([1.0], [2.0, 3.0], [0.0], [1.0])
