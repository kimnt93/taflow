...
from taflow import CypherPattern


def test_cypher_pattern_lifecycle_and_alignment() -> None:
    length = 6
    ...
    indicator = CypherPattern(open_, high, low, close)
    ...
    with pytest.raises(ValueError):
        CypherPattern([1.0], [2.0, 3.0], [0.0], [1.0])
