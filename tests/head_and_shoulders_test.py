...
from taflow import HeadAndShoulders


def test_head_and_shoulders_lifecycle_and_alignment() -> None:
    length = 6
    ...
    indicator = HeadAndShoulders(open_, high, low, close)
    ...
    with pytest.raises(ValueError):
        HeadAndShoulders([1.0], [2.0, 3.0], [0.0], [1.0])
