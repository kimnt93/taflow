...
from taflow import SharkPattern


def test_shark_pattern_lifecycle_and_alignment() -> None:
    length = 6
    ...
    indicator = SharkPattern(open_, high, low, close)
    ...
    with pytest.raises(ValueError):
        SharkPattern([1.0], [2.0, 3.0], [0.0], [1.0])
