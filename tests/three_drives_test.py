...
from taflow import ThreeDrives


def test_three_drives_lifecycle_and_alignment() -> None:
    length = 6
    ...
    indicator = ThreeDrives(open_, high, low, close)
    ...
    with pytest.raises(ValueError):
        ThreeDrives([1.0], [2.0, 3.0], [0.0], [1.0])
