...
from taflow import GartleyPattern


def test_gartley_pattern_lifecycle_and_alignment() -> None:
    length = 6
    ...
    indicator = GartleyPattern(open_, high, low, close)
    ...
    with pytest.raises(ValueError):
        GartleyPattern([1.0], [2.0, 3.0], [0.0], [1.0])
