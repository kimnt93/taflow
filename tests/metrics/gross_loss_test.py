...
def test_gross_loss_boundaries_missing_invalid_and_factory_contract() -> None:
    ...
    with pytest.raises(ValueError):
        GrossLoss.from_pnl([np.nan], nan_policy="raise")
    with pytest.raises(ValueError):
