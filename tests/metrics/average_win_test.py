...
def test_average_win_raw_pnl_and_trade_factories_match_quantstats() -> None:
...
def test_average_win_boundaries_missing_and_invalid_values() -> None:
    ...
    with pytest.raises(ValueError):
        AverageWin.from_returns([np.nan], nan_policy="raise")
    with pytest.raises(ValueError):
...
def test_average_win_requires_semantic_factory() -> None:
